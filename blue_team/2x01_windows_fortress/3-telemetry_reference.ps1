...
[pscustomobject]@{event_id=1102;event_name="Audit Log Cleared";log_source="Security";audit_or_sensor_dependency="Audit System";security_meaning="Security audit log was cleared";normal_frequency="Very Low";triage_priority="Critical";crimson_tide_phase="Defense Evasion";example_suspicious_pattern="Log clearing without approved maintenance, sign of an attack such as a ransomware";validation_method="Get-WinEvent -FilterHashtable @{LogName='Security';Id=1102}"},
# PowerShell
