...
| Detailed IP info | `ipconfig /all`                                     | `ip addr show`<br>`ifconfig -a`             |
...
| Task            | Windows                           | Linux                              |
|-----------------|-----------------------------------|-------------------------------------|
| Lookup          | `nslookup hostname`                | `dig hostname`<br>`host hostname`  |
...
| Task         | Windows              | Linux                                    |
|--------------|----------------------|-------------------------------------------|
| View ARP cache| `arp -a`            | `arp -n`<br>`ip neigh show`               |
...
| Task                      | Windows                                      | Linux                                |
|---------------------------|----------------------------------------------|--------------------------------------|
| All connections           | `netstat -an`                                | `ss -an`<br>`netstat -an`            |
...
| Test port                 | `Test-NetConnection host -Port 80`           | `nc -vz host 80`<br>`telnet host 80` |
| Kill connection / process | `taskkill /PID <PID> /F`<br>Use Task Manager | `kill <PID>`                         |
...
| Current connection | `netsh wlan show interfaces`            | `iwconfig`<br>`nmcli con show`         |
...
| RDP (Linux)       | `rdesktop hostname`<br>`xfreerdp /v:hostname`|
